/**
 * Footer social icons — Telegram, Instagram, YouTube, X, Discord (simple-icons
 * paths, fill=currentColor). Muted gray, brighten on hover; shared by the
 * desktop and flow footers. Telegram/YouTube/X URLs mirror PROD loadhunter.io
 * (checked 2026-07-21); the Discord URL is TODO until the server exists.
 */
export function SocialLinks() {
  return (
    <div className="flex items-center gap-[16px] text-[rgba(255,255,255,0.45)]">
      ...
      {/* TODO: real Discord invite when the server exists */}
      <a href="#" aria-label="LoadHunter on Discord" className="transition-colors hover:text-white">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
